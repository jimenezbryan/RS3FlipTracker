import { Home, BarChart3, Briefcase, Target, Sparkles, TrendingUp, Bell, BookOpen, Shield, Users, Search, CalendarDays, Activity, Shovel } from "lucide-react";
...
const navItems = [
  ...
  { href: "/archaeology", label: "Archaeology", icon: Shovel },
];
